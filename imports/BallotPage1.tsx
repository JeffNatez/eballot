import svgPaths from "./svg-80t55wph7a";
  ...
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Graduate Elections Banner</p>
      </div>
      <Tag />
    </div>
  );
...
function Card() {
  return (
    <div className="h-[226px] relative rounded-[6px] shrink-0 w-[150px]" data-name="card">
      <div className="content-stretch flex flex-col h-[226px] items-center overflow-clip relative rounded-[inherit] w-[150px]">
        <ImageContainer />
        <TextContent />
      </div>
...
function Image1() {
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Campus Activities Committee Icon</p>
      </div>
      <Tag1 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="text content">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start p-[8px] relative text-black w-full">
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Campus Activities Elections 2025
          </p>
          <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Upcoming
          </p>
...
function Image2() {
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Quality Circle Elections Graphic</p>
      </div>
      <Tag2 />
    </div>
  );
...
function List() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[8px] h-[245px] items-center justify-center left-[-1px] overflow-clip px-[12px] py-0 top-[674px] w-[441px]" data-name="list">
      <Row />
    </div>
  );
}
...
function Content() {
  return (
    <div className="absolute box-border content-stretch flex gap-[8px] items-center left-0 px-[8px] py-[12px] top-[23px] w-[360px]" data-name="content">
      <IcLeft />
...
function Input() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[4px] h-[99px] items-start justify-center left-0 overflow-clip px-[12px] py-0 top-[135px] w-[440px]" data-name="Input">
...
function Chip() {
  return (
    <div className="bg-[rgba(0,0,0,0.05)] box-border content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[6px] shrink-0 w-[64px]" data-name="chip">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        All
      </p>
    </div>
  );
...
function Chip2() {
  return (
    <div className="bg-[rgba(0,0,0,0.05)] box-border content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[6px] shrink-0" data-name="chip">
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre" style={{ fontVariationSettings: "'wdth' 100" }}>
        Upcoming
      </p>
    </div>
...
function ChipGroup() {
  return (
    <div className="content-stretch flex gap-[8px] items-start relative shrink-0 w-full" data-name="chip-group">
      <Chip />
      <Chip1 />
      <Chip2 />
      <Chip3 />
...
function Selection() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[4px] h-[76px] items-center left-[4px] overflow-clip px-[12px] py-0 top-[234px] w-[436px]" data-name="Selection">
      <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[14px] text-black w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        Filter Elections
      </p>
      <ChipGroup />
...
function Image3() {
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Guild Executive Elections Banner</p>
      </div>
      <Tag3 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="text content">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start p-[8px] relative text-black w-full">
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Guild Executive Elections 2025
          </p>
          <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Open
          </p>
...
function Image4() {
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Student Council Elections Icon</p>
      </div>
      <Tag4 />
    </div>
  );
...
function Image5() {
  return (
    <div className="basis-0 bg-[rgba(0,0,0,0.05)] grow h-full min-h-px min-w-px relative shrink-0" data-name="image">
      <div className="absolute flex flex-col font-['Roboto:Regular',sans-serif] font-normal h-[16px] justify-center leading-[0] left-[16px] right-[16px] text-[12px] text-black text-center top-1/2 translate-y-[-50%]" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[16px]">Environment Committee Elections Graphic</p>
      </div>
      <Tag5 />
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="text content">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[4px] items-start p-[8px] relative text-black w-full">
          <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[16px] relative shrink-0 text-[12px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Environment Committee Elections 2024
          </p>
          <p className="font-['Roboto:Medium',sans-serif] font-medium leading-[24px] relative shrink-0 text-[16px] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
            Closed
          </p>
...
function List1() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[8px] h-[274px] items-center justify-center left-[-4px] overflow-clip px-[12px] py-0 top-[306px] w-[440px]" data-name="list">
      <SectionTitle />
      <Row1 />
    </div>
  );
...
function Button() {
  return (
    <div className="absolute box-border content-stretch flex gap-[8px] items-start left-[28px] overflow-clip px-[12px] py-0 top-[603px] w-[360px]" data-name="Button">
      <Seconday />
      <Primary />
    </div>
  );
...
export default function BallotPage() {
  return (
    <div className="bg-white relative size-full" data-name="Ballot page 1">
      <StatusBarIPhone />
      <List />
      <NavBar />
      <Header />
