import svgPaths from "./svg-pupwv1bee6";
...
function Card() {
  return (
    <div className="absolute bg-white h-[606px] left-1/2 rounded-[20px] shadow-[0px_4px_12px_0px_rgba(0,0,0,0.25)] top-[271px] translate-x-[-50%] w-[402px]" data-name="Card">
...
function BackBtn() {
  return (
    <div className="absolute h-[35px] left-[27px] top-[64px] w-[76px]" data-name="BACK BTN">
...
export default function LoginAsVoterScreen() {
  return (
    <div className="bg-[rgba(255,255,255,0.87)] relative size-full" data-name="LOGIN AS VOTER SCREEN">
      <StatusBarIPhone />
